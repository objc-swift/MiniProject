...
class DemoListViewController: UIViewController {
    ...
    @IBOutlet weak var bottomView: HorizontalListView!
    ...
    override func viewDidLoad() {
        ...
        for addr in addrs {
            ...
            self.bottomView.listItems.append(HorizontalListViewItem(cellClass: nil, viewModel: HorizontalListViewCellViewModel(entity: "AD Insert" as AnyObject)))
        }
        
        self.topView.style = .normal
        self.bottomView.style = .zoom
